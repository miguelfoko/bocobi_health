...
/**
 * Generated class for the MesConstantes2Page page.
 *
...
@IonicPage()
@Component({
  selector: 'page-mes-constantes2',
  templateUrl: 'mes-constantes2.html',
})
export class MesConstantes2Page {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad MesConstantes2Page');
  }
